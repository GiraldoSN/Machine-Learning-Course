...
# 5. Memberikan Nilai untuk Multiple Variable Anda dapat memberikan nilai untuk multiple variable dengan cara berikut.
data = ['shirt', 'white', 'L']
...
# 6. Fungsi sort() digunakan untuk mengurutkan angka atau huruf. Berikut contoh implementasinya.
