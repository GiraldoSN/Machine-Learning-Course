...
"""
Kode program di atas menampilkan pesan teks "selamat" jika kondisi bernilai true dan menampilkan pesan teks "perbaiki" jika kondisi bernilai false.
Jika kita transformasikan menjadi bentuk blok, berikut adalah kodenya.
"""
